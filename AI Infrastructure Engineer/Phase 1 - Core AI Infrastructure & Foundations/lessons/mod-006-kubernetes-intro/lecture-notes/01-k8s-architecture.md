...
graph TB
    subgraph Cluster ["Kubernetes Cluster"]
        ...
        subgraph Workers ["Worker Nodes"]
            ...
            subgraph Node1 ["Node 1"]
                ...
                Proxy1(["kube-proxy"]):::proxy
                Runtime1(["Container Runtime\n(Docker, containerd, CRI-O)"]):::runtime
                Pods1(["Pods"]):::pods
            ...
            subgraph Node3 ["Node 3"]
                direction TB
                Kubelet3(["kubelet"]):::agent
                Proxy3(["kube-proxy"]):::proxy
    ...
    %% Connections from Workers to Control Plane to align nodes side-by-side
    Kubelet1 -.-> API
    Kubelet2 -.-> API
    Kubelet3 -.-> API
    ...
    classDef agent fill:#374151,stroke:#6b7280,color:#fff,font-weight:bold
    classDef proxy fill:#4b5563,stroke:#9ca3af,color:#fff,font-weight:bold
    classDef runtime fill:#1f2937,stroke:#4b5563,color:#fff,font-weight:bold
    classDef pods fill:#047857,stroke:#10b981,color:#fff,font-weight:bold
```
...
graph TD
    subgraph Node ["Worker Node"]
        ...
        Kubelet(["kubelet\n(Node agent, Pod lifecycle)"]):::agent
        Runtime(["Container Runtime\n(Docker, containerd, CRI-O)"]):::runtime
        Proxy(["kube-proxy\n(Network proxy, load balancing)"]):::proxy
        Plugins(["Optional: Device Plugins\n(GPU, FPGA, InfiniBand, etc.)"]):::plugin
        
        subgraph Pods ["Pods"]
            direction LR
            C1(["Container 1"]):::container
            C2(["Container 2"]):::container
        end
    ...
    classDef runtime fill:#1f2937,stroke:#4b5563,color:#fff,font-weight:bold
    classDef proxy fill:#4b5563,stroke:#9ca3af,color:#fff,font-weight:bold
    classDef plugin fill:#475569,stroke:#334155,color:#fff,font-weight:bold
