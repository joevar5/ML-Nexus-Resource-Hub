...
- **Module:** Cloud Platforms & AWS
- **Total Questions:** 50 (+ 1 bonus)
- **Time Limit:** 90 minutes
- **Passing Score:** 80% (40/50 correct)
- **Topics Covered:**
  - Cloud fundamentals, service models, and deployment models
  - AWS core services (EC2, S3, RDS, IAM, EBS, ECR)
  - AWS networking and security (VPC, subnets, Security Groups, NACLs)
  - Container orchestration (ECS, EKS, Kubernetes)
  - ML workloads and SageMaker
  - Cost optimization and best practices

## Instructions

1. Read each question carefully and choose the best answer.
2. Questions marked **\[SELECT ALL\]** have multiple correct answers.
3. Unless noted, each question has a single correct answer.
4. Explanations follow each answer to reinforce core concepts.
