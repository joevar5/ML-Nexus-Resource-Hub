...
2. [Functional Requirements (FR)](#functional-requirements-fr)
   - [FR-1: Data Engineering & Versioning](#fr-1-data-engineering--versioning)
   - [FR-2: Training & Tracking Pipeline](#fr-2-training--tracking-pipeline)
   - [FR-3: Model Registry Management](#fr-3-model-registry-management)
   - [FR-4: Pipeline Orchestration & Workflow](#fr-4-pipeline-orchestration--workflow)
...
6. [System Constraints & Assumptions](#system-constraints--assumptions)
...
### FR-1: Data Engineering & Versioning
...
### FR-2: Training & Tracking Pipeline
...
### FR-4: Pipeline Orchestration & Workflow
